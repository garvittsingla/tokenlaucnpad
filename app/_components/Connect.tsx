...
export default function Connect(){
    ...
    return(
        <div className="p-5   w-full  flex items-center flex-col gap-3 justify-center">
            ...
            <WalletMultiButton />
            <div className="w-full  md:flex  gap-6 bg--900 h-1/2 md:px-20  py-5 space-y-5">
                <div className="bg--900 h-full border p-6 rounded-md md:w-1/2 w-full flex  flex-col gap-5">
                <h1 className="text-3xl font-[boldonse]">What we Do?</h1>
                    <div className="text-xl -y-1 md:ml-10 text-[#BBBBBB]">
                ...
                <div className="bg--900 h-82 border p-6 rounded-md md:w-1/2 w-full flex flex-col gap-5">
