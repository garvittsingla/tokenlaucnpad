...
export default function Home() {
  ...
  return (
    <div className="bg-[#1a1a1a] min-h-screen flex items-center justify-center w-full text-white ">
      <Toaster/>
      <div className="border backdrop-blur-sm bg-black/50 shadow-lg shadow-purple-500/10 mt-5 md:mt-0 mb-10 md:mb-0 border-white/20 h-11/12 w-15/16 rounded-xl">
